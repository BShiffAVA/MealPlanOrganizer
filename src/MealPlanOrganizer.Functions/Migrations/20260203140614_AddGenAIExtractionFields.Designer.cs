...
namespace MealPlanOrganizer_Functions.Migrations
{
    ...
    [Migration("20260203140614_AddGenAIExtractionFields")]
    partial class AddGenAIExtractionFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MealPlanOrganizer.Functions.Data.Entities.Recipe", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedUtc = new DateTime(2026, 2, 3, 14, 6, 14, 440, DateTimeKind.Utc).AddTicks(4189),
