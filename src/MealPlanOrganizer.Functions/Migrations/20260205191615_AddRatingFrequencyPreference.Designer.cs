...
namespace MealPlanOrganizer_Functions.Migrations
{
    ...
    [Migration("20260205191615_AddRatingFrequencyPreference")]
    partial class AddRatingFrequencyPreference
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MealPlanOrganizer.Functions.Data.Entities.Recipe", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedUtc = new DateTime(2026, 2, 5, 19, 16, 5, 628, DateTimeKind.Utc).AddTicks(7755),
