...
namespace MealPlanOrganizer_Functions.Migrations
{
    ...
    [Migration("20260226143624_ReplaceFrequencyWithNextTimePreference")]
    partial class ReplaceFrequencyWithNextTimePreference
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MealPlanOrganizer.Functions.Data.Entities.PendingRating", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("MealPlanRecipeId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("MealPlanRecipeId");

                    b.HasIndex("RecipeId");

                    b.HasIndex("HouseholdId", "Status");

                    b.HasIndex("UserId", "MealPlanRecipeId")
                        .IsUnique();

                    b.HasIndex("UserId", "Status");

                    b.ToTable("PendingRatings", (string)null);
                });
            ...
            modelBuilder.Entity("MealPlanOrganizer.Functions.Data.Entities.RecipeRating", b =>
                {
                    ...
                    b.Property<string>("NextTimePreference")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("MealPlanOrganizer.Functions.Data.Entities.PendingRating", b =>
                {
                    ...
                    b.HasOne("MealPlanOrganizer.Functions.Data.Entities.MealPlanRecipe", "MealPlanRecipeEntry")
                        .WithMany()
                        .HasForeignKey("MealPlanRecipeId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("MealPlanRecipeEntry");
